...
.method private a(Ljava/lang/RuntimeException;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/w;->o:Landroid/support/v4/app/FragmentActivity;
...
# virtual methods
.method public a(Landroid/support/v4/app/j;)I
    .locals 4
...
.method public a()Landroid/support/v4/app/ae;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/app/j;-><init>(Landroid/support/v4/app/w;)V
...
.method a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    :cond_3
    invoke-static {p2, p3}, Landroid/support/v4/app/w;->b(IZ)I
    ...
    invoke-static {v0, v1, v3, v4, v3}, Landroid/support/v4/app/w;->a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v3, v5, v3, v4}, Landroid/support/v4/app/w;->a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v5, v3, v4, v3}, Landroid/support/v4/app/w;->a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v3, v1, v3, v4}, Landroid/support/v4/app/w;->a(Landroid/content/Context;FFFF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v4, v3}, Landroid/support/v4/app/w;->a(Landroid/content/Context;FF)Landroid/view/animation/Animation;
    ...
    invoke-static {v0, v3, v4}, Landroid/support/v4/app/w;->a(Landroid/content/Context;FF)Landroid/view/animation/Animation;
...
.method a(IIIZ)V
    ...
    iget-object v0, v1, Landroid/support/v4/app/Fragment;->M:Landroid/support/v4/app/ah;
...
.method public a(ILandroid/support/v4/app/j;)V
    .locals 4
...
.method a(IZ)V
    ...
    invoke-virtual {p0, p1, v0, v0, p2}, Landroid/support/v4/app/w;->a(IIIZ)V
...
.method a(Landroid/os/Parcelable;Ljava/util/ArrayList;)V
    ...
    iget-object v5, p0, Landroid/support/v4/app/w;->o:Landroid/support/v4/app/FragmentActivity;
    ...
    iget-object v3, p0, Landroid/support/v4/app/w;->o:Landroid/support/v4/app/FragmentActivity;
    ...
    invoke-virtual {v1, p0}, Landroid/support/v4/app/BackStackState;->a(Landroid/support/v4/app/w;)Landroid/support/v4/app/j;
    ...
    iget v5, v1, Landroid/support/v4/app/j;->o:I
    ...
    iget v3, v1, Landroid/support/v4/app/j;->o:I

    if-ltz v3, :cond_14

    iget v3, v1, Landroid/support/v4/app/j;->o:I

    invoke-virtual {p0, v3, v1}, Landroid/support/v4/app/w;->a(ILandroid/support/v4/app/j;)V
...
.method a(Landroid/support/v4/app/Fragment;IIIZ)V
    ...
    iget-object v0, v0, Landroid/support/v4/app/Fragment;->u:Landroid/support/v4/app/w;

    :goto_2
    iput-object v0, p1, Landroid/support/v4/app/Fragment;->s:Landroid/support/v4/app/w;
    ...
    iget-object v0, v0, Landroid/support/v4/app/FragmentActivity;->b:Landroid/support/v4/app/w;
    ...
    iget-object v0, p0, Landroid/support/v4/app/w;->p:Landroid/support/v4/app/t;

    iget v1, p1, Landroid/support/v4/app/Fragment;->x:I

    invoke-interface {v0, v1}, Landroid/support/v4/app/t;->a(I)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, p3, v5, p4}, Landroid/support/v4/app/w;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/app/w;->e(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {p0, p1, p3, v3, p4}, Landroid/support/v4/app/w;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-direct {v1, p0, p1}, Landroid/support/v4/app/y;-><init>(Landroid/support/v4/app/w;Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/app/w;->d(Landroid/support/v4/app/Fragment;)V
    ...
    iput-object v7, p1, Landroid/support/v4/app/Fragment;->s:Landroid/support/v4/app/w;
...
.method public a(Landroid/support/v4/app/Fragment;Z)V
    ...
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v4/app/w;->c(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/app/w;->b(Landroid/support/v4/app/Fragment;)V

    :cond_4
    return-void
.end method

.method public a(Landroid/support/v4/app/FragmentActivity;Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;)V
    .locals 2
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/v4/app/w;->o:Landroid/support/v4/app/FragmentActivity;

    iput-object p2, p0, Landroid/support/v4/app/w;->p:Landroid/support/v4/app/t;
...
.method public a(Ljava/lang/Runnable;Z)V
    ...
    invoke-direct {p0}, Landroid/support/v4/app/w;->t()V
...
.method public a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3, p2, p3, p4}, Landroid/support/v4/app/j;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method a(Landroid/os/Handler;Ljava/lang/String;II)Z
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/j;->b(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/j;->b()Ljava/lang/String;
    ...
    iget v0, v0, Landroid/support/v4/app/j;->o:I
    ...
    :goto_6
    invoke-virtual {v0, v1}, Landroid/support/v4/app/j;->b(Z)V
...
.method public b(Landroid/support/v4/app/Fragment;II)V
    ...
    invoke-virtual {p0, p1, p2, v3, p3}, Landroid/support/v4/app/w;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
...
.method public b()Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/w;->e()Z
...
.method public c(Landroid/support/v4/app/Fragment;II)V
    ...
    invoke-virtual {p0, p1, p2, v4, p3}, Landroid/support/v4/app/w;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
...
.method public c()Z
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/w;->b()Z
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Landroid/support/v4/app/w;->a(Landroid/os/Handler;Ljava/lang/String;II)Z
...
.method d()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/w;->a(Landroid/support/v4/app/Fragment;)V
...
.method public e()Z
    ...
    iget-object v5, v0, Landroid/support/v4/app/Fragment;->M:Landroid/support/v4/app/ah;

    if-eqz v5, :cond_3

    iget-object v0, v0, Landroid/support/v4/app/Fragment;->M:Landroid/support/v4/app/ah;
    ...
    iget-object v1, p0, Landroid/support/v4/app/w;->o:Landroid/support/v4/app/FragmentActivity;
...
.method f()V
    ...
    invoke-interface {v0}, Landroid/support/v4/app/v;->a()V
...
.method h()Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/w;->f(Landroid/support/v4/app/Fragment;)Landroid/os/Bundle;
    ...
    invoke-direct {v4, p0, v0}, Landroid/support/v4/app/BackStackState;-><init>(Landroid/support/v4/app/w;Landroid/support/v4/app/j;)V
...
.method public r()V
    ...
    iput-object v1, p0, Landroid/support/v4/app/w;->o:Landroid/support/v4/app/FragmentActivity;

    iput-object v1, p0, Landroid/support/v4/app/w;->p:Landroid/support/v4/app/t;
