...
.method a()V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/ai;->d:Landroid/support/v4/content/c;
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/ag;->a(ILandroid/os/Bundle;)Landroid/support/v4/content/c;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/ai;->d:Landroid/support/v4/content/c;
    ...
    iget-object v2, p0, Landroid/support/v4/app/ai;->d:Landroid/support/v4/content/c;
...
.method a(Landroid/support/v4/content/c;Ljava/lang/Object;)V
    ...
    iget-object v1, v1, Landroid/support/v4/app/ah;->e:Landroid/support/v4/app/FragmentActivity;

    if-eqz v1, :cond_4

    iget-object v0, p0, Landroid/support/v4/app/ai;->o:Landroid/support/v4/app/ah;

    iget-object v0, v0, Landroid/support/v4/app/ah;->e:Landroid/support/v4/app/FragmentActivity;

    iget-object v0, v0, Landroid/support/v4/app/FragmentActivity;->b:Landroid/support/v4/app/w;

    iget-object v0, v0, Landroid/support/v4/app/w;->u:Ljava/lang/String;

    iget-object v1, p0, Landroid/support/v4/app/ai;->o:Landroid/support/v4/app/ah;

    iget-object v1, v1, Landroid/support/v4/app/ah;->e:Landroid/support/v4/app/FragmentActivity;

    iget-object v1, v1, Landroid/support/v4/app/FragmentActivity;->b:Landroid/support/v4/app/w;

    const-string v2, "onLoadFinished"

    iput-object v2, v1, Landroid/support/v4/app/w;->u:Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/ag;->a(Landroid/support/v4/content/c;Ljava/lang/Object;)V
    :try_end_0
    ...
    iput-object v1, v0, Landroid/support/v4/app/w;->u:Ljava/lang/String;
    ...
    iget-object v2, v2, Landroid/support/v4/app/ah;->e:Landroid/support/v4/app/FragmentActivity;
    ...
    iget-object v2, v2, Landroid/support/v4/app/FragmentActivity;->b:Landroid/support/v4/app/w;

    iput-object v1, v2, Landroid/support/v4/app/w;->u:Ljava/lang/String;
...
.method c()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/ai;->a(Landroid/support/v4/content/c;Ljava/lang/Object;)V
...
.method f()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/ai;->d:Landroid/support/v4/content/c;
    ...
    iput-object v3, v1, Landroid/support/v4/app/w;->u:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/support/v4/app/ai;->d:Landroid/support/v4/content/c;

    invoke-interface {v0, v3}, Landroid/support/v4/app/ag;->a(Landroid/support/v4/content/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
