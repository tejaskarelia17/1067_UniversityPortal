...
.field final c:Landroid/support/v4/app/t;
...
.field m:Landroid/support/v4/app/ah;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/app/p;-><init>(Landroid/support/v4/app/FragmentActivity;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->b:Landroid/support/v4/app/w;

    new-instance v0, Landroid/support/v4/app/q;

    invoke-direct {v0, p0}, Landroid/support/v4/app/q;-><init>(Landroid/support/v4/app/FragmentActivity;)V

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->c:Landroid/support/v4/app/t;
...
.method a(Ljava/lang/String;ZZ)Landroid/support/v4/app/ah;
    ...
    invoke-direct {v0, p1, p0, p2}, Landroid/support/v4/app/ah;-><init>(Ljava/lang/String;Landroid/support/v4/app/FragmentActivity;Z)V
    ...
    :cond_2
    invoke-virtual {v0, p0}, Landroid/support/v4/app/ah;->a(Landroid/support/v4/app/FragmentActivity;)V
...
.method a(Ljava/lang/String;)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/app/ah;->g:Z
...
.method d()V
    ...
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->m:Landroid/support/v4/app/ah;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    iget-object v1, v1, Landroid/support/v4/app/w;->f:Ljava/util/ArrayList;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->c:Landroid/support/v4/app/t;

    invoke-virtual {v0, p0, v2, v1}, Landroid/support/v4/app/w;->a(Landroid/support/v4/app/FragmentActivity;Landroid/support/v4/app/t;Landroid/support/v4/app/Fragment;)V
    ...
    iget-object v2, v0, Landroid/support/v4/app/s;->e:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Landroid/support/v4/app/s;->d:Ljava/util/ArrayList;

    :goto_0
    invoke-virtual {v3, v2, v0}, Landroid/support/v4/app/w;->a(Landroid/os/Parcelable;Ljava/util/ArrayList;)V
...
.method public onCreateView(Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    sget-object v2, Landroid/support/v4/app/r;->a:[I
    ...
    invoke-virtual {v1, v5}, Landroid/support/v4/app/w;->a(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    iput-object v1, v4, Landroid/support/v4/app/Fragment;->s:Landroid/support/v4/app/w;
    ...
    invoke-virtual {v1, v4, v8}, Landroid/support/v4/app/w;->a(Landroid/support/v4/app/Fragment;Z)V
    ...
    invoke-virtual {v3, v1}, Landroid/support/v4/app/w;->b(Landroid/support/v4/app/Fragment;)V
...
.method public onPreparePanel(ILandroid/view/View;Landroid/view/Menu;)Z
    ...
    invoke-virtual {v2, p3}, Landroid/support/v4/app/w;->a(Landroid/view/Menu;)Z
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/w;->g()Ljava/util/ArrayList;
    ...
    new-array v6, v1, [Landroid/support/v4/app/ah;
    ...
    iget-boolean v8, v7, Landroid/support/v4/app/ah;->g:Z
    ...
    :cond_1
    invoke-virtual {v7}, Landroid/support/v4/app/ah;->h()V

    iget-object v8, p0, Landroid/support/v4/app/FragmentActivity;->l:Ljava/util/HashMap;

    iget-object v7, v7, Landroid/support/v4/app/ah;->d:Ljava/lang/String;
    ...
    iput-object v3, v0, Landroid/support/v4/app/s;->a:Ljava/lang/Object;

    iput-object v4, v0, Landroid/support/v4/app/s;->b:Ljava/lang/Object;

    iput-object v3, v0, Landroid/support/v4/app/s;->c:Ljava/util/HashMap;

    iput-object v5, v0, Landroid/support/v4/app/s;->d:Ljava/util/ArrayList;

    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->l:Ljava/util/HashMap;

    iput-object v1, v0, Landroid/support/v4/app/s;->e:Ljava/util/HashMap;
...
.method protected onStart()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/w;->e()Z
    ...
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->m:Landroid/support/v4/app/ah;

    if-eqz v1, :cond_3

    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->m:Landroid/support/v4/app/ah;

    invoke-virtual {v1}, Landroid/support/v4/app/ah;->b()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/w;->l()V
    ...
    new-array v1, v1, [Landroid/support/v4/app/ah;
    ...
    invoke-virtual {v2}, Landroid/support/v4/app/ah;->e()V

    invoke-virtual {v2}, Landroid/support/v4/app/ah;->g()V
    ...
    invoke-virtual {p0, v1, v2, v0}, Landroid/support/v4/app/FragmentActivity;->a(Ljava/lang/String;ZZ)Landroid/support/v4/app/ah;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/app/FragmentActivity;->m:Landroid/support/v4/app/ah;
    ...
    iget-boolean v1, v1, Landroid/support/v4/app/ah;->f:Z
