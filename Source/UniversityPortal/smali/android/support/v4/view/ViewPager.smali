...
.field private static final af:Landroid/support/v4/view/bm;
...
.field private R:Landroid/support/v4/widget/f;
...
.field private W:Landroid/support/v4/view/bi;
...
.field private final f:Landroid/support/v4/view/bg;
...
.field private n:Landroid/support/v4/view/bk;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->af:Landroid/support/v4/view/bm;
...
.method private a(IIII)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/bg;
...
.method private a(IZIZ)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/bg;
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/bi;
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->Z:Landroid/support/v4/view/bi;
    ...
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/bi;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/bi;

    invoke-interface {v2, p1}, Landroid/support/v4/view/bi;->a(I)V

    :cond_3
    if-eqz p4, :cond_4

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->Z:Landroid/support/v4/view/bi;
...
.method private a(Landroid/support/v4/view/bg;ILandroid/support/v4/view/bg;)V
    ...
    invoke-virtual {v5, v2}, Landroid/support/v4/view/ae;->a(I)F
    ...
    invoke-virtual {v9, v1}, Landroid/support/v4/view/ae;->a(I)F
...
.method private b(F)Z
    ...
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/f;
...
.method private g()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->af:Landroid/support/v4/view/bm;
...
.method private h()Landroid/support/v4/view/bg;
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Landroid/support/v4/view/bg;
    ...
    invoke-virtual {v6, v7}, Landroid/support/v4/view/ae;->a(I)F
...
.method private setScrollState(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/bj;
...
.method a(II)Landroid/support/v4/view/bg;
    .locals 2
    ...
    invoke-virtual {v1, p1}, Landroid/support/v4/view/ae;->a(I)F
...
.method a(Landroid/view/View;)Landroid/support/v4/view/bg;
    .locals 4
...
.method a()V
    ...
    iget-object v9, v0, Landroid/support/v4/view/bg;->a:Ljava/lang/Object;
    ...
    :cond_3
    iget v9, v0, Landroid/support/v4/view/bg;->b:I
...
.method a(I)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/bg;
    ...
    iget v7, v2, Landroid/support/v4/view/bg;->b:I
    ...
    invoke-virtual {v0, v2, v5}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/bg;
    ...
    :cond_5
    iget v6, v10, Landroid/support/v4/view/bg;->d:F
    ...
    invoke-direct {v0, v10, v8, v4}, Landroid/support/v4/view/ViewPager;->a(Landroid/support/v4/view/bg;ILandroid/support/v4/view/bg;)V
    ...
    iget-object v2, v10, Landroid/support/v4/view/bg;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bg;

    move-result-object v6

    if-eqz v6, :cond_8

    iget v7, v6, Landroid/support/v4/view/bg;->d:F
    ...
    iget v7, v10, Landroid/support/v4/view/bg;->d:F
    ...
    :cond_c
    iget v15, v2, Landroid/support/v4/view/bg;->b:I

    if-ne v9, v15, :cond_d

    iget-boolean v15, v2, Landroid/support/v4/view/bg;->c:Z
    ...
    iget-object v2, v2, Landroid/support/v4/view/bg;->a:Ljava/lang/Object;
    ...
    iget v2, v2, Landroid/support/v4/view/bg;->d:F
    ...
    invoke-virtual {v0, v9, v2}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/bg;
    ...
    :cond_15
    iget v11, v2, Landroid/support/v4/view/bg;->b:I

    if-ne v9, v11, :cond_20

    iget-boolean v11, v2, Landroid/support/v4/view/bg;->c:Z
    ...
    invoke-virtual {v0, v9, v7}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/bg;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Landroid/view/View;)Landroid/support/v4/view/bg;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bg;
...
.method protected a(IFI)V
    ...
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/bj;
...
.method a(III)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v4/view/ae;->a(I)F
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    invoke-virtual {p0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bg;
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bg;
...
.method b(I)Landroid/support/v4/view/bg;
    .locals 3
...
.method b(Landroid/view/View;)Landroid/support/v4/view/bg;
    .locals 2
    ...
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bg;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/f;
    ...
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/f;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v3, v5}, Landroid/support/v4/view/ae;->a(I)F
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v8}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bg;
    ...
    iget v10, v10, Landroid/support/v4/view/bg;->e:F
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/bg;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->Q:Landroid/support/v4/widget/f;
...
.method public setAdapter(Landroid/support/v4/view/ae;)V
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->n:Landroid/support/v4/view/bk;
    ...
    invoke-direct {v1, p0, v5}, Landroid/support/v4/view/bk;-><init>(Landroid/support/v4/view/ViewPager;Landroid/support/v4/view/bd;)V

    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->n:Landroid/support/v4/view/bk;

    :cond_2
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/ae;

    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->n:Landroid/support/v4/view/bk;
    ...
    invoke-interface {v1, v0, p1}, Landroid/support/v4/view/bh;->a(Landroid/support/v4/view/ae;Landroid/support/v4/view/ae;)V
...
.method setOnAdapterChangeListener(Landroid/support/v4/view/bh;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->aa:Landroid/support/v4/view/bh;
...
.method public setOnPageChangeListener(Landroid/support/v4/view/bi;)V
    ...
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/bi;
