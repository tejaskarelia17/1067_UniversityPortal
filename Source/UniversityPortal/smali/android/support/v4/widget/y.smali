...
.method private constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/support/v4/widget/ab;)V
    .locals 3
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/aa;-><init>(Landroid/support/v4/widget/y;)V

    iput-object v0, p0, Landroid/support/v4/widget/y;->w:Ljava/lang/Runnable;
    ...
    :cond_1
    iput-object p2, p0, Landroid/support/v4/widget/y;->u:Landroid/view/ViewGroup;

    iput-object p3, p0, Landroid/support/v4/widget/y;->r:Landroid/support/v4/widget/ab;
    ...
    iput v1, p0, Landroid/support/v4/widget/y;->o:I

    invoke-virtual {v0}, Landroid/view/ViewConfiguration;->getScaledTouchSlop()I

    move-result v1

    iput v1, p0, Landroid/support/v4/widget/y;->b:I
    ...
    iput v1, p0, Landroid/support/v4/widget/y;->m:F
    ...
    sget-object v0, Landroid/support/v4/widget/y;->v:Landroid/view/animation/Interpolator;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/y;->q:Landroid/support/v4/widget/k;
...
.method private a(III)I
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/widget/y;->b(F)F
...
.method private a(Landroid/view/View;IIII)I
    ...
    :goto_1
    iget-object v4, p0, Landroid/support/v4/widget/y;->r:Landroid/support/v4/widget/ab;

    invoke-virtual {v4, p1}, Landroid/support/v4/widget/ab;->a(Landroid/view/View;)I
    ...
    invoke-virtual {v4, p1}, Landroid/support/v4/widget/ab;->b(Landroid/view/View;)I
...
.method public static a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ab;)Landroid/support/v4/widget/y;
    .locals 3

    invoke-static {p0, p2}, Landroid/support/v4/widget/y;->a(Landroid/view/ViewGroup;Landroid/support/v4/widget/ab;)Landroid/support/v4/widget/y;

    move-result-object v0

    iget v1, v0, Landroid/support/v4/widget/y;->b:I
    ...
    iput v1, v0, Landroid/support/v4/widget/y;->b:I

    return-object v0
.end method

.method public static a(Landroid/view/ViewGroup;Landroid/support/v4/widget/ab;)Landroid/support/v4/widget/y;
    .locals 2
    ...
    invoke-direct {v0, v1, p0, p1}, Landroid/support/v4/widget/y;-><init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/support/v4/widget/ab;)V
...
.method private a(FF)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/y;->r:Landroid/support/v4/widget/ab;

    iget-object v1, p0, Landroid/support/v4/widget/y;->s:Landroid/view/View;

    invoke-virtual {v0, v1, p1, p2}, Landroid/support/v4/widget/ab;->a(Landroid/view/View;FF)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/y;->c(I)V
...
.method private a(FFI)V
    ...
    invoke-direct {p0, p3}, Landroid/support/v4/widget/y;->g(I)V
    ...
    invoke-direct {p0, v1, v2}, Landroid/support/v4/widget/y;->f(II)I
...
.method private a(FFII)Z
    ...
    iget-object v2, p0, Landroid/support/v4/widget/y;->r:Landroid/support/v4/widget/ab;

    invoke-virtual {v2, p4}, Landroid/support/v4/widget/ab;->b(I)Z
...
.method private a(IIII)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/y;->q:Landroid/support/v4/widget/k;

    invoke-virtual {v1}, Landroid/support/v4/widget/k;->g()V

    invoke-virtual {p0, v0}, Landroid/support/v4/widget/y;->c(I)V
    ...
    iget-object v4, p0, Landroid/support/v4/widget/y;->q:Landroid/support/v4/widget/k;
    ...
    invoke-virtual/range {v4 .. v9}, Landroid/support/v4/widget/k;->a(IIIII)V
...
.method private a(Landroid/view/View;FF)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/ab;->a(Landroid/view/View;)I
    ...
    :goto_1
    iget-object v3, p0, Landroid/support/v4/widget/y;->r:Landroid/support/v4/widget/ab;

    invoke-virtual {v3, p1}, Landroid/support/v4/widget/ab;->b(Landroid/view/View;)I
...
.method private b(FFI)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/y;->r:Landroid/support/v4/widget/ab;

    invoke-virtual {v1, v0, p3}, Landroid/support/v4/widget/ab;->b(II)V
...
.method private b(IIII)V
    ...
    invoke-virtual {v2, v3, p1, p3}, Landroid/support/v4/widget/ab;->a(Landroid/view/View;II)I
    ...
    invoke-virtual {v3, v4, p2, p4}, Landroid/support/v4/widget/ab;->b(Landroid/view/View;II)I
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v4/widget/ab;->a(Landroid/view/View;IIII)V
...
.method public a(F)V
    ...
    iput p1, p0, Landroid/support/v4/widget/y;->n:F
...
.method public a(I)V
    ...
    iput p1, p0, Landroid/support/v4/widget/y;->p:I
...
.method public a(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/widget/ab;->b(Landroid/view/View;I)V
...
.method public a(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v2, v3}, Landroid/support/v4/widget/y;->e(II)Landroid/view/View;
    ...
    invoke-virtual {v3, v2, v4}, Landroid/support/v4/widget/ab;->a(II)V
    ...
    invoke-virtual {v4, v3, v2}, Landroid/support/v4/widget/ab;->a(II)V
    ...
    invoke-virtual {p0, v4, v3}, Landroid/support/v4/widget/y;->e(II)Landroid/view/View;
    ...
    invoke-virtual {p0, v5, v6}, Landroid/support/v4/widget/y;->e(II)Landroid/view/View;
    ...
    invoke-direct {p0, v2}, Landroid/support/v4/widget/y;->f(I)V
...
.method public a(Z)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/y;->q:Landroid/support/v4/widget/k;
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/k;->b()I
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/k;->e()I
    ...
    :cond_5
    invoke-virtual {p0, v6}, Landroid/support/v4/widget/y;->c(I)V
...
.method public b(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {p0, v3, v4}, Landroid/support/v4/widget/y;->e(II)Landroid/view/View;
    ...
    invoke-virtual {v2, v1, v0}, Landroid/support/v4/widget/ab;->a(II)V
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v4/widget/y;->e(II)Landroid/view/View;
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v4/widget/y;->d(II)Z
...
.method public b(II)Z
    ...
    invoke-virtual {p0, p2}, Landroid/support/v4/widget/y;->b(I)Z
...
.method b(Landroid/view/View;I)Z
    ...
    invoke-virtual {v1, p1, p2}, Landroid/support/v4/widget/ab;->a(Landroid/view/View;I)Z
...
.method public e(II)Landroid/view/View;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/ab;->c(I)I
...
.method public e(I)Z
    ...
    invoke-virtual {p0, p1, v1}, Landroid/support/v4/widget/y;->c(II)Z
